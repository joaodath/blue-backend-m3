...
async function dbconnect() {
    try {
        await client.connect( () => console.log(`Connection to MongoDB successful. Using database: ${process.env.DB_NAME}`));
    } catch(err) {
...
async function dbclose() {
    try {
        await client.close(() => console.log('Connection to MongoDB succesfully closed.'));
    } catch(err) {
